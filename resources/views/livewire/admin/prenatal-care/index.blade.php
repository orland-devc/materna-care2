<x-layouts.app :title="__('Prenatal Care')">
    <div class="flex flex-col gap-6">
        <!-- Header Section -->
        <div class="mb-8">
            <flux:heading size="xl" level="1">{{ __('Prenatal Care for Expecting Mothers') }}</flux:heading>
            <flux:subheading size="lg" class="text-zinc-600 dark:text-zinc-400">{{ __('Guidance, support, and essential healthcare for a healthy pregnancy journey.') }}</flux:subheading>
        </div>
        ...
        <div class="overflow-hidden border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-800 rounded-xl shadow-sm">
            ...
            <div class="flex flex-col md:flex-row items-center p-6">
                ...
                <div class="w-full md:w-2/3 flex flex-col items-center md:items-start text-center md:text-left">
                    <h1 class="text-7xl font-bold text-blue-600 dark:text-blue-400 mb-4">Coming Soon</h1>
                    <p class="text-zinc-700 dark:text-zinc-300 text-lg mb-4">We're working hard to bring you this feature.</p>
                    <p class="text-zinc-700 dark:text-zinc-300 text-lg mb-4">Thank you for your patience as we improve our healthcare platform.</p>
