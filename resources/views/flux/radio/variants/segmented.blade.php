...
$classes = Flux::classes()
    ...
    ->add('data-checked:bg-white dark:data-checked:bg-indigo-600/30')
...
$iconClasses = Flux::classes('dark:text-zinc-400 [ui-radio[data-checked]_&]:text-zinc-800 dark:[ui-radio[data-checked]_&]:text-white')
    // Add color if provided, otherwise use default text-zinc-500
    ->add($iconColor ? "{$iconColor}" : 'text-zinc-500')
